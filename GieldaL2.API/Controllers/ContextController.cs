...
namespace GieldaL2.API.Controllers
{
    ...
    public class ContextController : ControllerBase
    {
        ...
        public ContextController(IUserService userService, IBuyOfferService buyOfferService, ISellOfferService sellOfferService)
        {
        ...
        public ActionResult<StatisticsViewModel<ContextViewModel>> Get()
        {
            ...
            statistics.Data = new ContextViewModel
            {
                ...
                // Shares = Mapper.Map<ShareViewModel>(sharesDto),
